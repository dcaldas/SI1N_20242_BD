...
DELETE FROM CLIENTES WHERE CPF_CLIENTE = 112233445;
DELETE FROM CLIENTES WHERE CPF_CLIENTE = 556677889;
DELETE FROM CLIENTES WHERE CPF_CLIENTE = 667788990;
DELETE FROM PRODUTOS WHERE ID_PROD = 1;
DELETE FROM PRODUTOS WHERE ID_PROD = 2;
DELETE FROM PRODUTOS WHERE ID_PROD = 3;
DELETE FROM PRODUTOS WHERE ID_PROD = 4;
DELETE FROM PRODUTOS WHERE ID_PROD = 5;
DELETE FROM FORNECEDORES WHERE ID_FORN = 1;
DELETE FROM FORNECEDORES WHERE ID_FORN = 2;
DELETE FROM FORNECEDORES WHERE ID_FORN = 3;
DELETE FROM FORNECEDORES WHERE ID_FORN = 4;
DELETE FROM FORNECEDORES WHERE ID_FORN = 5;
DELETE FROM ESTOQUE WHERE ID_ESTOQUE = 1;
DELETE FROM ESTOQUE WHERE ID_ESTOQUE = 2;
DELETE FROM ESTOQUE WHERE ID_ESTOQUE = 3;
DELETE FROM ESTOQUE WHERE ID_ESTOQUE = 4;
